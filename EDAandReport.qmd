...
# Data
The primary dataset for this analysis is the "List of Largest Cities" from Wikipedia, which compiles recent population estimates for the world's largest urban agglomerations. A key challenge in urban data analysis is the definition of "city," as political boundaries often differ from physical settlements.
