...
#| tbl-alt: A table showing population and area statistics for the top six countries.
...
#| out-width: "70%"
#| fig-alt: Graph showing urban population vs. urban area for six countries with distinct colored lines.
...
#| out-width: "70%"
#| fig-alt: Line graph of city populations by area for Brazil, China, India, Indonesia, Japan, and the United States.
...
#| out-width: "85%"
#| fig-alt: Scatter plot showing city density vs. area for six countries with colored points representing each country.
...
#| out-width: "85%"
#| fig-alt: Scatter plot of urban area vs. density for six countries, represented by colored dots.
